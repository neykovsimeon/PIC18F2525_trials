...
//#define __XLCD_H
#include "p18cxxx.h"
/** \brief PIC18 XLCD peripheral routines.
 *
 *   Notes:
 ...
 * or lower nibble of MCU's data port.  For lower nibble, comment the #define UPPER
 */
// #define UPPER
 ...
 * In case changes are introduce to match application's specifics
 * then source files should be explicitly included in your project
 * so they are re-compiled as a part of the project.
 * One could also decide (or explicitly need) to redirect this header file
 * in another, project specific location
 */
