...
# 13 "../../common/include/plib\delays.h"
...
const char menu_001[] = "Option1";
const char menu_002[] = "Option2";
const char menu_003[] = "Option3";
const char menu_004[] = "Option4";
const char menu_005[] = "Option5";
const char menu_006[] = "Option6";
const char menu_007[] = "Option7";
const char menu_008[] = "Option8";
const char menu_009[] = "START";

const char menu_010[] = "<Sub Menu>";
const char menu_011[] = "SubOption1";
const char menu_012[] = "SubOption2";
const char menu_013[] = "SubOption3";
const char menu_014[] = "SubOption4";
const char menu_015[] = "SubOption5";
const char menu_016[] = "RETURN";
...
case 2: {
ddramaddress = (0x14 + x_pos);
break;
}
case 3: {
ddramaddress = (0x54 + x_pos);
break;
}
default: {
ddramaddress = (0x00 + x_pos);
...
if (lcd_offset > 20) lcd_offset = 20;
...
if (add_line){
for (lcd_i = 20 - lcd_offset - x; lcd_i; lcd_i--) {
while(BusyXLCD());
